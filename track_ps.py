...
def detect(opt):
    ...
    # print("asdasdasdasdasd",deep_sort_model)
...
#//    print("DEEPSSSSSSSS",deepsort)   
#//    print("OPT_DNN",opt.dnn)
#//    print("OPT_Device", opt.device)
#//    print("imgsz", imgsz)
#//    print("augment", opt.augment)
#//    print("yaml", opt.config_deepsort)
#//    print("half", opt.half)
#//    print(dir(opt))
#//    print(a = w)   
    # Initialize
    ...
    for frame_idx, (path, img, im0s, vid_cap, s) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            # print("Checking if saving video...")
            ...
            if save_vid:
               ...
               # print(jpg.tobytes())
                ...
                #+str(frame_idx)+ ".png", im0)
                
#                frame1 = cv2.imencode('.jpg', im0)[1].tobytes()  # Remove this line for test camera
...
#                   b'Content-Type: image/jpeg\r\n\r\n' + frame1 + b'\r\n')
                ...
                #cv2.imwrite("/home/asyed/my_docker/Yolov5_DeepSort_Pytorch/runs/track/exp90/img_" +str(frame_idx)+ ".png", im0) 
